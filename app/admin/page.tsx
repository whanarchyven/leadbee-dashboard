...
export default function AdminPage() {
  ...
  const setGlobalStats = useMutation(api.stats.setGlobalStats);
  ...
  // Подтягиваем текущие глобальные значения
  const dayTotals = useQuery(api.stats.summaryGlobal, {});
  useEffect(() => {
    if (dayTotals) {
  ...
  }, [dayTotals?.conversations, dayTotals?.accounts, dayTotals?.revenue]);
  ...
  return (
    <main className="p-6 max-w-3xl mx-auto flex flex-col gap-6">
      ...
      <Card>
        <CardHeader className="font-medium">Задать показатели</CardHeader>
        <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-3 items-end">
          ...
          <SaveButton
            ...
            onClick={async () => {
              ...
              await setGlobalStats({ conversations, accounts, revenue });
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <input
              ...
              onChange={async (e) => {
                ...
                await update({
                  ...
                  revenueCap: settings?.revenueCap ?? 0,
                  ...
                  conversationsCap: settings?.conversationsCap ?? 0,
                  ...
                  accountsCap: settings?.accountsCap ?? 0,
                });
          ...
          <Stepper
            ...
            dailyCap={settings?.revenueCap ?? 0}
            onChange={async (s, i) => {
          ...
          <Stepper
            ...
            dailyCap={settings?.conversationsCap ?? 0}
            onChange={async (s, i) => {
          ...
          <Stepper
            ...
            dailyCap={settings?.accountsCap ?? 0}
            onChange={async (s, i) => {
